...
GameObject& ObjectManager::CreateGameObject(const XMFLOAT3 localPosition, const XMFLOAT3 scale, const float speed, GameObjectType type, std::string* name, const long id, const bool isStatic, const int modelId, const int textureId)
{
